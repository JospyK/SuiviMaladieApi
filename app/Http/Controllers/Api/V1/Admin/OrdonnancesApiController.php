...
class OrdonnancesApiController extends Controller
{
    public function index()
    {
        abort_if(Gate::denies('ordonnance_access'), Response::HTTP_FORBIDDEN, '403 Forbidden');

        return new OrdonnanceResource(Ordonnance::with(['consultation'])->get());
    }
    ...
    public function show(Ordonnance $ordonnance)
    {
        ...
        return new OrdonnanceResource($ordonnance->load(['consultation']));
    }
